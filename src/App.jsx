            ...
            <div style={{
              ...
              <ResponsiveContainer width="100%" height={400}>
                <LineChart data={riskCurrentData} margin={{ top: 10, right: 24, left: 12, bottom: 0 }}>
                  <CartesianGrid strokeDasharray="3 3" stroke="rgba(255,255,255,0.04)" />
                  <XAxis dataKey="label" tick={{ fill: "#666", fontSize: 13 }} axisLine={{ stroke: "rgba(255,255,255,0.06)" }}
                    interval={Math.max(1, Math.floor(years / 8))} />
                  <YAxis tickFormatter={formatYenShort} tick={{ fill: "#666", fontSize: 13 }} axisLine={{ stroke: "rgba(255,255,255,0.06)" }} width={60} />
                  ...
                  <Tooltip content={({ active, payload }) => {
                    ...
                    const d = payload[0]?.payload;
                    return (
                      <div style={{ background: "rgba(15,15,20,0.95)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 14, padding: "16px 20px", fontSize: 14 }}>
                        ...
                        <div style={{ color: "#666", marginTop: 10, borderTop: "1px solid rgba(255,255,255,0.06)", paddingTop: 10 }}>
