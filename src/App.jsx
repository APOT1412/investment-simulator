...
function RateInput({ value, onChange }) {
  ...
  return (
    <div style={{
      ...
      background: "rgba(30,45,75,0.5)", borderRadius: 8,
      border: "1px solid rgba(100,140,200,0.25)", padding: "6px 10px", gap: 4, width: 80,
    }}>
      <input
...
export default function InvestmentSimulation() {
  ...
  return (
    <div style={{
      minHeight: "100vh",
      background: "linear-gradient(145deg, #0f1729 0%, #1a2744 50%, #0f1729 100%)",
      color: "#e0e0e0",
      ...
      <div style={{ maxWidth: 960, margin: "0 auto" }}>
        ...
        <div style={{
          ...
          background: "rgba(15,25,50,0.6)", borderRadius: 16, padding: 6,
          border: "1px solid rgba(100,140,200,0.25)",
        }}>
          <button
        ...
        <button onClick={() => setShowSetup(!showSetup)} style={{
          ...
          background: showSetup ? "rgba(78,205,196,0.1)" : "rgba(25,40,70,0.6)",
        ...
        {showSetup && (
          <div style={{
            background: "rgba(22,35,60,0.6)", borderRadius: 20,
            padding: "28px", marginBottom: 28, border: "1px solid rgba(100,140,200,0.2)",
          }}>
            <div style={{ marginBottom: 24 }}>
              <div style={{
                ...
                <span style={{ fontSize: 14, color: "#6b6b80", fontWeight: 600, textAlign: "center" }}>海外</span>
                <span></span>
              </div>
                  ...
                  <div style={{ display: "flex", justifyContent: "center" }}>
                    <button
                      ...
                      style={{
                        ...
                        background: fund.isForeign ? "rgba(78,205,196,0.15)" : "rgba(25,40,70,0.6)",
            ...
            <div style={{ display: "flex", gap: 14, marginBottom: 24, alignItems: "center" }}>
              <input
                ...
                style={{
                  flex: 1, background: "rgba(30,45,75,0.5)",
                  border: "1px solid rgba(100,140,200,0.25)", borderRadius: 12,
            ...
            <div style={{
              ...
              {[
                ...
                <div key={item.label} style={{ flex: 1, minWidth: 120 }}>
                  <div style={{ fontSize: 13, color: "#6b6b80", marginBottom: 4 }}>{item.label}</div>
            ...
            {activeTab === "simulation" && (
              <>
                <button onClick={() => setShowRates(!showRates)} style={{
                  ...
                  border: "1px solid rgba(100,140,200,0.2)", background: "rgba(22,35,60,0.6)",
          ...
          <>
                ...
                <div style={{ display: "flex", gap: 10 }}>
                  {["conservative", "base", "optimistic"].map((key) => (
                    <button key={key} onClick={() => setScenario(key)} style={{
                      ...
                      border: scenario === key ? "2px solid #4ecdc4" : "1px solid rgba(100,140,200,0.25)",
                      background: scenario === key ? "rgba(78,205,196,0.12)" : "rgba(25,40,70,0.6)",
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16, marginBottom: 28 }}>
              {[
                ...
                { label: "累計投資額", value: formatYen(finalData.contributed), color: "#aaa", bg: "rgba(25,40,70,0.6)", border: "rgba(100,140,200,0.2)" },
              ].map((card) => (
            ...
            {/* 3 Scenario Chart */}
            <div style={{
              background: "rgba(22,35,60,0.6)", borderRadius: 22,
              padding: "28px 20px 20px", marginBottom: 28, border: "1px solid rgba(30,45,75,0.5)",
            }}>
              ...
              <ResponsiveContainer width="100%" height={360}>
                <AreaChart data={chartData} margin={{ top: 10, right: 24, left: 12, bottom: 0 }}>
                  ...
                  <XAxis dataKey="label" tick={{ fill: "#666", fontSize: 14 }} axisLine={{ stroke: "rgba(100,140,200,0.2)" }} interval={Math.max(1, Math.floor(years / 7))} />
                  <YAxis tickFormatter={formatYenShort} tick={{ fill: "#666", fontSize: 14 }} axisLine={{ stroke: "rgba(100,140,200,0.2)" }} width={65} />
                  <Tooltip content={({ active, payload }) => {
                    if (!active || !payload?.length) return null;
                    const d = payload[0]?.payload;
                    return (
                      <div style={{ background: "rgba(15,25,45,0.95)", border: "1px solid rgba(100,140,200,0.2)", borderRadius: 14, padding: "16px 20px", fontSize: 15, color: "#e0e0e0" }}>
                        ...
                        <div style={{ color: "#666", marginTop: 10, borderTop: "1px solid rgba(100,140,200,0.2)", paddingTop: 10 }}>投資元本: {formatYen(d.contributed)}</div>
                      </div>
                    );
                  }} />
                  <Area type="monotone" dataKey="contributed" fill="rgba(25,40,70,0.6)" stroke="rgba(255,255,255,0.15)" strokeDasharray="4 4" strokeWidth={1} />
                  ...
                  <Tooltip content={({ active, payload }) => {
                    ...
                    return (
                      <div style={{ background: "rgba(15,25,45,0.95)", border: "1px solid rgba(100,140,200,0.2)", borderRadius: 14, padding: "16px 20px", fontSize: 15, color: "#e0e0e0" }}>
                        ...
                        <div style={{ borderTop: "1px solid rgba(100,140,200,0.2)", marginTop: 12, paddingTop: 12, display: "flex", justifyContent: "space-between" }}>
            ...
            <div style={{
              background: "rgba(22,35,60,0.6)", borderRadius: 22,
              padding: "28px 32px", marginBottom: 28, border: "1px solid rgba(30,45,75,0.5)",
            }}>
                ...
                {MILESTONES.map((m) => {
                  ...
                  return (
                    <div key={m.label} style={{
                      background: reached ? "rgba(78,205,196,0.06)" : "rgba(22,35,60,0.6)",
            ...
            <div style={{
              background: "rgba(22,35,60,0.6)", borderRadius: 22,
              padding: "28px 24px", marginBottom: 28, border: "1px solid rgba(30,45,75,0.5)", overflowX: "auto",
            }}>
              <div style={{ fontSize: 18, fontWeight: 600, color: "#aaa", marginBottom: 20 }}>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 15, minWidth: 480 }}>
                <thead>
                  <tr style={{ borderBottom: "1px solid rgba(100,140,200,0.25)" }}>
                ...
                <tbody>
                  {selectedData.filter((_, i) => {
                    ...
                    return (
                      <tr key={d.year} style={{ borderBottom: "1px solid rgba(25,40,70,0.6)" }}>
        ...
        {activeTab === "risk" && (
          <>
            ...
            <div style={{
              background: "rgba(22,35,60,0.6)", borderRadius: 20,
              padding: "24px 28px", marginBottom: 24, border: "1px solid rgba(100,140,200,0.2)",
            }}>
              ...
              <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
                ...
                <label style={{
                  display: "flex", alignItems: "center", gap: 10, padding: "12px 20px",
                  background: showCrashScenario ? "rgba(255,107,107,0.1)" : "rgba(25,40,70,0.6)",
                  borderRadius: 12, cursor: "pointer",
                  border: showCrashScenario ? "1px solid rgba(255,107,107,0.3)" : "1px solid rgba(100,140,200,0.25)",
                }}>
                  ...
                  <span style={{ fontSize: 15, color: showCrashScenario ? "#ff6b6b" : "#888", fontWeight: 500 }}>📉 株式暴落（-40%）</span>
                </label>

                {/* 円高シナリオ */}
                <label style={{
                  display: "flex", alignItems: "center", gap: 10, padding: "12px 20px",
                  background: showYenScenario ? "rgba(255,217,61,0.1)" : "rgba(25,40,70,0.6)",
                  borderRadius: 12, cursor: "pointer",
                  border: showYenScenario ? "1px solid rgba(255,217,61,0.3)" : "1px solid rgba(100,140,200,0.25)",
                }}>
                  ...
                  <span style={{ fontSize: 15, color: showYenScenario ? "#ffd93d" : "#888", fontWeight: 500 }}>💴 急激な円高（-30%）</span>
                </label>

                {/* 貯金のみ */}
                <label style={{
                  display: "flex", alignItems: "center", gap: 10, padding: "12px 20px",
                  background: showSavingsOnly ? "rgba(139,139,158,0.1)" : "rgba(25,40,70,0.6)",
                  borderRadius: 12, cursor: "pointer",
                  border: showSavingsOnly ? "1px solid rgba(139,139,158,0.3)" : "1px solid rgba(100,140,200,0.25)",
                }}>
                  ...
                  <span style={{ fontSize: 15, color: showSavingsOnly ? "#8b8b9e" : "#888", fontWeight: 500 }}>🏦 貯金のみ（0%成長）</span>
                </label>
              </div>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, marginBottom: 28 }}>
              <div style={{
                background: "rgba(22,35,60,0.6)", borderRadius: 16,
                padding: "20px 24px", border: "1px solid rgba(100,140,200,0.2)",
              }}>
              ...
              <div style={{
                ...
                padding: "20px 24px", border: "1px solid rgba(255,107,107,0.15)",
              }}>
                <div style={{ fontSize: 14, color: "#6b6b80", marginBottom: 10, fontWeight: 600 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 14, marginBottom: 28 }}>
              <div style={{
                ...
                <div style={{ fontSize: 12, color: "#6b6b80", marginBottom: 6 }}>📈 順調</div>
              ...
              <div style={{
                background: showCrashScenario ? "rgba(255,107,107,0.08)" : "rgba(22,35,60,0.6)",
                borderRadius: 16, padding: "18px 20px",
                border: showCrashScenario ? "1px solid rgba(255,107,107,0.2)" : "1px solid rgba(100,140,200,0.2)",
                opacity: showCrashScenario ? 1 : 0.4,
              }}>
                <div style={{ fontSize: 12, color: "#6b6b80", marginBottom: 6 }}>📉 暴落</div>
              ...
              <div style={{
                background: showYenScenario ? "rgba(255,217,61,0.08)" : "rgba(22,35,60,0.6)",
                borderRadius: 16, padding: "18px 20px",
                border: showYenScenario ? "1px solid rgba(255,217,61,0.2)" : "1px solid rgba(100,140,200,0.2)",
                opacity: showYenScenario ? 1 : 0.4,
              }}>
                <div style={{ fontSize: 12, color: "#6b6b80", marginBottom: 6 }}>💴 円高</div>
              ...
              <div style={{
                background: showSavingsOnly ? "rgba(139,139,158,0.08)" : "rgba(22,35,60,0.6)",
                borderRadius: 16, padding: "18px 20px",
                border: showSavingsOnly ? "1px solid rgba(139,139,158,0.2)" : "1px solid rgba(100,140,200,0.2)",
                opacity: showSavingsOnly ? 1 : 0.4,
              }}>
                <div style={{ fontSize: 12, color: "#6b6b80", marginBottom: 6 }}>🏦 貯金のみ</div>
            ...
            <div style={{
              ...
              <ResponsiveContainer width="100%" height={400}>
                <LineChart data={riskCurrentData} margin={{ top: 10, right: 24, left: 12, bottom: 0 }}>
                  <CartesianGrid strokeDasharray="3 3" stroke="rgba(255,255,255,0.04)" />
                  <XAxis dataKey="label" tick={{ fill: "#666", fontSize: 13 }} axisLine={{ stroke: "rgba(100,140,200,0.2)" }}
                    interval={Math.max(1, Math.floor(years / 8))} />
                  <YAxis tickFormatter={formatYenShort} tick={{ fill: "#666", fontSize: 13 }} axisLine={{ stroke: "rgba(100,140,200,0.2)" }} width={60} />
                  ...
                  <Tooltip content={({ active, payload }) => {
                    ...
                    const d = payload[0]?.payload;
                    return (
                      <div style={{ background: "rgba(15,25,45,0.95)", border: "1px solid rgba(100,140,200,0.2)", borderRadius: 14, padding: "16px 20px", fontSize: 14 }}>
                        ...
                        <div style={{ color: "#666", marginTop: 10, borderTop: "1px solid rgba(100,140,200,0.2)", paddingTop: 10 }}>
                          投資元本: {formatYen(d.contributed)}
                        </div>
                      </div>
                    );
                  }} />
                  <Line type="monotone" dataKey="contributed" stroke="rgba(255,255,255,0.25)" strokeDasharray="4 4" strokeWidth={2} dot={false} />
              ...
              <div style={{ display: "flex", justifyContent: "center", gap: 20, marginTop: 16, flexWrap: "wrap" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 14, color: "rgba(255,255,255,0.4)" }}>
                  <span style={{ width: 20, height: 4, background: "rgba(255,255,255,0.3)", borderRadius: 2, border: "1px dashed rgba(255,255,255,0.5)" }} />投資元本
                </div>
              </div>
            </div>
            ...
            <div style={{
              ...
              padding: "24px 28px", marginBottom: 28, border: "1px solid rgba(78,205,196,0.15)",
            }}>
              ...
              <div style={{ display: "grid", gap: 12 }}>
                {showCrashScenario && (
                  <div style={{ background: "rgba(255,107,107,0.08)", borderRadius: 12, padding: "16px 20px", border: "1px solid rgba(255,107,107,0.15)" }}>
                ...
                {showYenScenario && (
                  <div style={{ background: "rgba(255,217,61,0.08)", borderRadius: 12, padding: "16px 20px", border: "1px solid rgba(255,217,61,0.15)" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}>
                      <span style={{ fontSize: 20 }}>💴</span>
                ...
                {showSavingsOnly && (
                  <div style={{ background: "rgba(139,139,158,0.08)", borderRadius: 12, padding: "16px 20px", border: "1px solid rgba(139,139,158,0.15)" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}>
                      <span style={{ fontSize: 20 }}>🏦</span>
                ...
                <div style={{ background: "rgba(78,205,196,0.08)", borderRadius: 12, padding: "16px 20px", border: "1px solid rgba(78,205,196,0.15)" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}>
                    <span style={{ fontSize: 20 }}>🎯</span>
            ...
            <div style={{
              background: "rgba(22,35,60,0.6)", borderRadius: 20,
              padding: "24px 28px", marginBottom: 28, border: "1px solid rgba(30,45,75,0.5)",
            }}>
              <div style={{ fontSize: 16, fontWeight: 600, color: "#aaa", marginBottom: 16 }}>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 15 }}>
                <thead>
                  <tr style={{ borderBottom: "1px solid rgba(100,140,200,0.2)" }}>
                    <th style={{ padding: "12px 8px", textAlign: "left", color: "#6b6b80", fontWeight: 600 }}>シナリオ</th>
                    <th style={{ padding: "12px 8px", textAlign: "right", color: "#6b6b80", fontWeight: 600 }}>最終資産</th>
                    <th style={{ padding: "12px 8px", textAlign: "right", color: "#6b6b80", fontWeight: 600 }}>運用益</th>
                    <th style={{ padding: "12px 8px", textAlign: "right", color: "#6b6b80", fontWeight: 600 }}>貯金との差</th>
                  </tr>
                </thead>
                <tbody>
                  <tr style={{ borderBottom: "1px solid rgba(30,45,75,0.5)" }}>
                  ...
                  <tr style={{ borderBottom: "1px solid rgba(30,45,75,0.5)", opacity: showCrashScenario ? 1 : 0.3 }}>
                  ...
                  <tr style={{ borderBottom: "1px solid rgba(30,45,75,0.5)", opacity: showYenScenario ? 1 : 0.3 }}>
                  ...
                  <tr style={{ opacity: showSavingsOnly ? 1 : 0.3 }}>
                    ...
                    <td style={{ padding: "14px 8px", textAlign: "right", fontFamily: "'JetBrains Mono', monospace", color: "#888" }}>±0</td>
                    <td style={{ padding: "14px 8px", textAlign: "right", fontFamily: "'JetBrains Mono', monospace", color: "#888" }}>—</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div style={{
              ...
              padding: "16px 20px", marginBottom: 20, border: "1px solid rgba(255,217,61,0.15)",
            }}>
        ...
        {/* Footer Disclaimer */}
        <div style={{ fontSize: 12, color: "#4a4a5a", textAlign: "center", padding: "12px 20px", lineHeight: 1.8 }}>
